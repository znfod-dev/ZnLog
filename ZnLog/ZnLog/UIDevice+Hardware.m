...
- (NSUInteger) platformType
{
    ...
    if ([platform isEqualToString:@"iPhone2"])
    ...
    if ([platform isEqualToString:@"AppleTV5,3"])
        return UIDeviceAppleTV5;
    if ([platform isEqualToString:@"AppleTV6,2"])
        return UIDeviceAppleTV6;
    
    // HomePod
    if ([platform isEqualToString:@"AudioAccessory1,1"])
        return UIDeviceHomePod;
...
- (NSString *) platformString
{
    switch ([self platformType])
    {
        ...
        case UIDevice8PiPhone: return IPHONE_8P_NAMESTRING;
        ...
        case UIDeviceA1iPad : return IPAD_A1_NAMESTRING;
        case UIDeviceA2iPad : return IPAD_A2_NAMESTRING;
        case UIDeviceM1iPad : return IPAD_M1_NAMESTRING;
        case UIDeviceM2iPad : return IPAD_M2_NAMESTRING;
        case UIDeviceM3iPad : return IPAD_M3_NAMESTRING;
        case UIDeviceM4iPad : return IPAD_M4_NAMESTRING;
        case UIDevice9PiPad : return IPAD_9P_NAMESTRING;
        case UIDevice12P1GiPad : return IPAD_12P1G_NAMESTRING;
        case UIDevice12P2GiPad : return IPAD_12P2G_NAMESTRING;
        case UIDevice10PiPad : return IPAD_10P_NAMESTRING;
        ...
        case UIDeviceAppleTV6 : return APPLETV_6G_NAMESTRING;
        case UIDeviceUnknownAppleTV: return APPLETV_UNKNOWN_NAMESTRING;
            
        case UIDeviceHomePod : return HOMEPOD_1G_NAMESTRING;
